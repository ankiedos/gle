...
enum opcode // 0-138 instrs
{
	...
	OP_RET = 120,
	OP_THROW = 121, OP_CATCH = 122,

	// TYPE CAST OPERATIONS (0xE2)
	OP_I2F = 123,
	OP_F2I = 124, OP_L2I = OP_LABS,
	OP_I2S = 125, OP_F2S = 126, OP_L2S = 127,
	OP_I2A = 128, OP_F2A = 129, OP_L2A = 130,
	...
	// SPECIAL OPERATIONS
	OP_SYSCALL = 131, OP_BREAKPOINT = 132, OP_NOP = 133, OP_HOST_ISA = 134, OP_HOST_OS = 135,
	OP_ISWP = 136, OP_FSWP = 137, OP_LSWP = 138,
	OP_ASWP = 139
};

enum addr_mode
{
	AMODE_IMM, AMODE_REG, AMODE_CODE, AMODE_PTR, AMODE_REMOTE, AMODE_LOCAL, AMODE_LOCALPTR
};
